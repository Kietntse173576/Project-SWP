        ...
        <div className="container mx-auto py-8">
            ...
            <nav className="mb-4">
                <ol className="list-reset flex text-gray-700 ml-2">
                    ...
                    <li><a href="/checkout" className="text-gray-500">Thông tin giao hàng</a></li>
                    <li><span className="mx-2"><KeyboardArrowRightIcon /></span></li>
            ...
            <div className="flex justify-between">
                <div className="w-1/2 pr-8">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-between items-center">
                            <a href="/cart" className="text-blue-500 w-[75px] mr-2">Giỏ hàng</a>
                            <Button type="submit" className="w-1/2 h-12 bg-blue-500 text-white rounded">
                ...
                <Card className="w-1/2">
                    ...
                    <div className="flex justify-between mb-2">
                        ...
                        />
                        <Button className="w-1/3 p-2 bg-blue-300 rounded h-10">Áp dụng</Button>
                    </div>
                    <div className="border-b my-4"></div>
                    <div className="flex justify-between mb-2">
                        <p>Tạm tính</p>
